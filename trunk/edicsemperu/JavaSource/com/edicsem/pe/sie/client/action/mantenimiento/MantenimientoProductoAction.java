...
@SessionScoped
public class MantenimientoProductoAction extends
		BaseMantenimientoAbstractAction {

	private String mensaje;
	public static Log log = LogFactory
			.getLog(MantenimientoProductoAction.class);
	...
	public DataModel<ProductoSie> getProductosmodel() throws Exception {
		...
		productosmodel = new ListDataModel<ProductoSie>(
				objProductoService.listarProductos());
	...
	public List<SelectItem> getSelectItems() {
		...
		try {
			...
			for (int i = 0; i < lista.size(); i++) {
				...
				selectItems.add(new SelectItem(tipo.getIdtipoproducto(), tipo
						.getNombretipoproducto()));
			}
