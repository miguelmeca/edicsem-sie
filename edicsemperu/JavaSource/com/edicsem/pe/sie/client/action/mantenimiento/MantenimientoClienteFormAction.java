...
objUbigeoDomicilio = objUbigeoService.findUbigeo(objClienteSie.getIdcliente());
		...
		while (it.hasNext()) {
			...
			if (e.getValue().toString().equals(objUbigeoDomicilio.getCoddepartamento())) {
		...
		while (it2.hasNext()) {
			...
			log.info("key " + e.getKey() + " value " + e.getValue());
			if (e.getValue().toString().equals(objUbigeoDomicilio.getCodprovincia())) {
				ubigeoDefecto += "-" + (String) e.getKey();
		...
		while (it3.hasNext()) {
			...
			log.info("key " + e.getKey() + " value " + e.getValue());
			if (e.getValue().toString().equals(objUbigeoDomicilio.getIdubigeo()+"")) {
				ubigeoDefecto += "-" + (String) e.getKey();
	...
	public String insertar()  {
		log.info("insertar() ");
		log.info("insertar() " + isNewRecord() + " inicio del insert "		+ objClienteSie.getNombrecliente());
	...
	/**
	 * @param objDomicilioPersonaSie the objDomicilioPersonaSie to set
	 */
	public void setObjDomicilioPersonaSie(DomicilioPersonaSie objDomicilioPersonaSie) {
	...
	/**
	 * @param comboManagerDomicilio the comboManagerDomicilio to set
	 */
